...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/host/web-auth': { kind: 'none', reason: 'The host transport authentication plugin registers no model-facing surface.' },
  ...
  'packages/util/random-uuid': { kind: 'none', reason: 'The UUID helper is runtime infrastructure and registers nothing model-facing.' },
